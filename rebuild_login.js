...
content = content.replace(/<main class="sso-auth-page">[\s\S]*?<\/main>/g, premiumMain);
...
content = content.replace(/<script src="main\.js"><\/script>[\s\S]*?<\/html>/g, supabaseScript);

fs.writeFileSync(loginPath, content, 'utf8');
console.log("Successfully rebuilt login.html");
